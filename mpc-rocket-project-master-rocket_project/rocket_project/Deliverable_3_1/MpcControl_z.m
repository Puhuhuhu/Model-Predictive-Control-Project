classdef MpcControl_z < MpcControlBase
    ...
    methods
        ...
        function ctrl_opti = setup_controller(mpc, Ts, H)
            ...
            % Constraints
            % u in U = { u | Mu <= m }
            % input Pavg, 50% <= Pavg <= 80%
            us = 56.6667; %trim value
            M = [1; -1];
            m = [80-us; -50+us];
            ...
            xlabel('$v_z$', 'interpreter', 'latex', FontSize=40)
            ylabel('z', 'interpreter', 'latex',FontSize=40)

            title('subsystem z invariant set')
